...
export function TaskModal({ task, isOpen, onClose }: TaskModalProps) {
  ...
  const [comments, setComments] = useState<Comment[]>([
    { id: 1, user: "Mendoza", text: "Working on the search logic now.", timestamp: "2h ago" }
  ]);
  ...
  return (
    <div className="modal modal-open">
      <div className="modal-box w-11/24 max-w-3xl bg-base-100 p-0 overflow-hidden flex flex-col h-[600px]">
        {/* Header */}
