...
export function GridLayoutHome() {
    ...
    return (
        <div className="grid grid-cols-1 lg:grid-cols-[2fr_1fr] px-4 w-full mb-5 lg:h-[60vh]">
            {/* NexusFlow HomePage Hero */}
            <div className="">
                <div className="flex flex-col justify-center flex-wrap p-5 md:text-2xl lg:text-4xl font-extralight gap-3 h-full">
            ...
            {/* Auth Card */}
        <div className="bg-base-100 rounded-[var(--radius-box)] m-4 lg:m-10 shadow-lg flex items-center justify-center lg:h-full">
